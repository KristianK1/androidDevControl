package hr.kristiankliskovic.devcontrol.data.network.deviceService.mapper
...
fun mapDeviceData(data: String) {
    ...
    val deviceData = Gson().fromJson(data2, WSSDeviceData::class.java)
    ...
    Log.i("parsed", Gson().toJson(device))
    Log.i("parsed", "done")
}
